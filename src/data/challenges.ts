...
const baseChallenges: Challenge[] = [
  ...
  },
  {
    ...
    description: 'Build a complete CRUD backend with REST routes, validation, and consistent HTTP responses.',
    category: 'Backend API', skill: 'REST API', difficulty: 'Intermediate', estimatedMinutes: 60, xp: 200,
    requirements: ['Create GET, POST, PATCH, and DELETE routes', 'Validate request parameters and bodies', 'Return appropriate HTTP status codes', 'Centralize error handling', 'Test success and failure cases'], bonus: ['Add pagination', 'Document the API with OpenAPI'], tags: ['Backend', 'REST', 'API', 'CRUD'],
  },
  {
    id: 'rest-api-auth',
    title: 'REST API Authentication',
    description: 'Protect an API with clear authentication and server-side authorization rules.',
    category: 'Backend API', skill: 'Authentication & authorization', difficulty: 'Advanced', estimatedMinutes: 75, xp: 250,
    requirements: ['Create a sign-in route', 'Store passwords securely', 'Verify identity on protected routes', 'Separate authentication from authorization', 'Never expose sensitive data'], bonus: ['Add session renewal', 'Rate-limit sign-in attempts'], tags: ['Backend', 'REST', 'Auth', 'Security'],
  },
  {
    id: 'prisma-data-model',
    title: 'Data Modeling with Prisma',
    description: 'Design a relational Prisma schema and prepare the database with a reproducible migration.',
    category: 'Prisma ORM', skill: 'Schema & migrations', difficulty: 'Intermediate', estimatedMinutes: 50, xp: 200,
    requirements: ['Define models and their types', 'Create a relation between two models', 'Add useful constraints and indexes', 'Generate and apply a migration', 'Inspect data with Prisma Studio'], bonus: ['Add seed data', 'Document modeling decisions'], tags: ['Backend', 'Prisma', 'ORM', 'Database', 'SQL'],
  },
  {
    id: 'prisma-rest-api',
    title: 'Prisma-powered REST API',
    description: 'Connect a REST API to a database with Prisma Client and robust queries.',
    category: 'Prisma ORM', skill: 'Prisma Client', difficulty: 'Advanced', estimatedMinutes: 90, xp: 300,
    requirements: ['Initialize a shared Prisma Client', 'Create a resource in the database', 'Read a list with its relations', 'Update and delete a resource', 'Handle errors and missing records'], bonus: ['Add pagination and filters', 'Wrap an operation in a transaction'], tags: ['Backend', 'Prisma', 'REST', 'Database', 'CRUD'],
  },
  {
